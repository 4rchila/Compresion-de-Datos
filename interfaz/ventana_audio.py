...
class ReproductorAudio:
    ...
    def reproducir_wav(self, ruta: str):
        ...
        if os.path.splitext(ruta)[1].lower() != ".wav":
            ...
            raise ValueError("Solo se permite archivos wav")
        self.detener()
        if sa is not None:
            ...
            raise RuntimeError("Instala simpleaudio (aun no instalad )")

    def pausar(self):
        if not self._aviso_pausa:
            mb.showinfo("Pausa", "pausar reincicia audio ")
...
class App:
    ...
    def __init__(self, root: tk.Tk):
        ...
        self._ultima_descomp = None   # ultima ruta WAV creada al descomprimir
    ...
    def _layout(self):
        ...
        ttk.Label(fila2, text="Reproduce WAV .", style="Hint.TLabel").grid(row=0, column=0, sticky="w")
    ...
    def _accion_play_desde_flac(self):
        ...
        try:
            ...
            self._set_estado(f"Reproduciendo : {os.path.basename(wav_descomprimido)}")
